...
/**
 * Returns an array of indices (0-6) representing the "best days" for a given activity.
 * This can be used to annotate charts (e.g., highlight best days for outdoor sightseeing).
 */
export function getBestDaysForActivity(
  daily: any,
  activity: Activity,
  country?: string,
  city?: string
