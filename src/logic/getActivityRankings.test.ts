...
describe('getBestDaysForActivity', () => {
  ...
  it('returns empty array for unknown activity', () => {
    expect(getBestDaysForActivity(daily, 'UnknownActivity' as any as Activity)).toEqual([]);
  });

  it('returns empty array for missing activity', () => {
    expect(getBestDaysForActivity(daily, undefined as any)).toEqual([]);
  });

  it('returns empty array for empty daily', () => {
    expect(getBestDaysForActivity({} as any, 'Skiing')).toEqual([]);
  });

  it('returns empty array for undefined daily', () => {
    expect(getBestDaysForActivity(undefined as any, 'Skiing')).toEqual([]);
  });
